...
<context>
    ...
    <message>
        ...
        <translation>如果自訂手續費設定為 1000 terracoins ，而交易資料大小只有 250 個位元組的話，那麽選擇「每千位元組」就只會付 250 terracoins 的手續費，&lt;br /&gt;而「至少」會支付 1000 terracoins。但是如果交易資料大小超過一千個位元組，那麽兩者都是每千位元組的費用。</translation>
    </message>
    <message>
        ...
        <translation>如果自訂手續費設定為 1000 terracoins ，而交易資料大小只有 250 個位元組的話，那麽選擇「每千位元組」就只會付 250 terracoins 的手續費，&lt;br /&gt;而「總共至少」會支付 1000 terracoins。但是如果交易資料大小超過一千個位元組，那麽兩者都是每千位元組的費用。</translation>
    </message>
    <message>
