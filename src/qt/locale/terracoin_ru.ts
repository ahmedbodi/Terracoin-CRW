...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для клиента Terracoin на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл Terracoin из текущего каталога данных. Для больших лог-файлов эта операция может занять несколько секунд.</translation>
    </message>
    <message>
        <source>&amp;Open</source>
...
<context>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к  Terracoin (Мастерноды, Darksend, InstantX, бюджеты) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Terracoin Alert" admin@foo.com
        ...
        <translation>Для использования terracoind или опции -server с terracoin-qt, вы должны установить опцию rpcpassword в конфигурационном файле:
%s
...
Например: alertnotify=echo %%s | mail -s "Terracoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: пожалуйста, убедитесь что дата и время на Вашем компьютере выставлены правильно! Terracoin Core не сможет работать корректно, если часы настроены неверно.</translation>
    </message>
    <message>
