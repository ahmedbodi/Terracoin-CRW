...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Terracoin Core"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Terracoin Core help message to get a list with possible Terracoin command-line options"));
