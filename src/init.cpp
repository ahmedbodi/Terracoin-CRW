...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "terracoin.conf") + "\n";
...
#ifndef WIN32
    strUsage += "  -pid=<file>            " + strprintf(_("Specify pid file (default: %s)"), "terracoind.pid") + "\n";
#endif
    ...
    strUsage += "                           terracoin (or specifically: darksend, instantx, throne, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        strUsage += ", qt";
    strUsage += ".\n";
#ifdef ENABLE_WALLET
    ...
    strUsage += "  -litemode=<n>          " + strprintf(_("Disable all Terracoin specific functionality (Thrones, Darksend, InstantX, Budgeting) (0-1, default: %u)"), 0) + "\n";
    ...
    strUsage += "  -anonymizeterracoinamount=<n>     " + strprintf(_("Keep N CRW anonymized (default: %u)"), 0) + "\n";
...
/** Sanity checks
 *  Ensure that Terracoin is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeTerracoinAmount = GetArg("-anonymizeterracoinamount", 0);
    if(nAnonymizeTerracoinAmount > 934099) nAnonymizeTerracoinAmount = 934099;
    if(nAnonymizeTerracoinAmount < 2) nAnonymizeTerracoinAmount = 2;
    ...
    LogPrintf("Anonymize Terracoin Amount %d\n", nAnonymizeTerracoinAmount);
